  ...
  try {
    ...
    if (chartElement) {
      try {
        ...
        doc.text("Multi-File Chart Image", 95, 95, { align: "center" })
      }
    } else {
      doc.rect(20, 55, 170, 80)
      doc.text("Multi-File Chart Image", 95, 95, { align: "center" })
    ...
    doc.rect(133.32, 135, 56.66, 8)
    doc.text("FINES", 161.65, 141, { align: "center" })
    ...
    doc.rect(133.32, 143, 56.66, 6)
    doc.text("SILT | CLAY", 161.65, 147, { align: "center" })
